...
<div style="text-align:center ">
		<form action="/Bank3.1/bankdate/item.do?command=transfer" method="post">
		<br><br><br><br><br><br>
		<label for="pass" style="color:white;font-size:30px">请输入转至账户名：</label>
		<input id="pass" style="width:370px;height:50px" name="TName" type="text" class="input">
		<br><br>
		<label for="pass" style="color:white;font-size:30px">请输入转账金额：</label>
		<input id="pass" style="width:400px;height:50px" name="traMoney" type="text" class="input">
		<br><br><br><br><br>
		<input type="submit" style="background-color:#262626;color:white;font-size:39px" value="转账">
		</form>
</div>

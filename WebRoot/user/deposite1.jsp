		...
		<div class="navigation-inner">
			<div class="navigation-v3">
				<ul>
					...
					<li _t_nav="support">						
						<form action="/bankdate/item.do?command=exitsystem" method="post">
						<input type="submit" class="button" value="注销">
						</form>
					</li>
				</ul>
			</div>
...
<div style="text-align:center ">
		<form action="/Bank3.1/bankdate/item.do?command=deposite" method="post">
		<br><br><br><br><br><br>
		<label for="pass" style="color:white;font-size:30px">请输入存款金额：</label>
		<br><br><br>
		<input id="pass" style="width:370px;height:39px" name="depMoney" type="text" class="input">
		<br><br><br><br><br><br>
		<input type="submit"  style="background-color:#262626;color:white;font-size:39px" value="存款">
		</form>
</div>
